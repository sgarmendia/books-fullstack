...
var getBooks = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, books_1.BookModel.getAll()];
        case 1: return [2 /*return*/, _a.sent()];
    }
}); }); };
exports.getBooks = getBooks;
var upsertBook = function (book) { return __awaiter(void 0, void 0, void 0, function () {
    var createdBook, updatedBook;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!book.id) return [3 /*break*/, 2];
...
exports.upsertBook = upsertBook;
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var book;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, books_1.BookModel.findById({ id: id })];
            case 1:
                book = _a.sent();
                if (!book) {
...
var deleteBook = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, books_1.BookModel.delete({ id: id })];
            case 1:
